...
public class EventoController implements Serializable {
    ...
    public void setCurrent(Evento current) {
        this.current = current;
    }

    public uis.giib.administrador.dao.EventoFacade getEjbFacade() {
        return ejbFacade;
    }

    public void setEjbFacade(uis.giib.administrador.dao.EventoFacade ejbFacade) {
