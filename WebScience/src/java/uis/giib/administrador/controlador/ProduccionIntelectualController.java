...
import uis.giib.administrador.dao.ProduccionIntelectualFacade;
...
public class ProduccionIntelectualController implements Serializable {
    ...
    private ProduccionIntelectual current;
    private DataModel items = null;
    @EJB
    private uis.giib.administrador.dao.ProduccionIntelectualFacade ejbFacade;
    ...
    public ProduccionIntelectual getSelected() {
        if (current == null) {
            current = new ProduccionIntelectual();
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String prepareView() {
        current = (ProduccionIntelectual) getItems().getRowData();
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProduccionIntelectualCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProduccionIntelectualUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("ProduccionIntelectualDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class ProduccionIntelectualControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof ProduccionIntelectual) {
                ...
                return getStringKey(o.getIdProduccion());
            } else {
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + ProduccionIntelectual.class.getName());
            }
        }
    }
}
